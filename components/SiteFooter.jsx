...
export default function SiteFooter() {
  return (
    <footer className="site-footer">
      ...
      <p className="footer-tagline">Analyser. Innover. <em>Développer.</em></p>
      <nav aria-label="Liens du pied de page">
        <Link href="/projets">Projets</Link><Link href="/cv">CV</Link><a href={contact.links[0].href} target="_blank" rel="noreferrer">GitHub</a><a href={contact.links[1].href} target="_blank" rel="noreferrer">LinkedIn</a><a href={contact.links[3].href} target="_blank" rel="noreferrer">Boutique</a><a href={contact.links[4].href} target="_blank" rel="noreferrer">X</a>
      </nav>
