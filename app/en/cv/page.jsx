...
export const metadata = {
  title: "CV",
  description:
    "Download the Agroeconomics, Data Engineering, Development, and Full Profile CVs of Georgeo Agbahungba, in French and English.",
  ...
  openGraph: {
    ...
    description:
      "The right profile for the right challenge: Agroeconomics, Data Engineering, Development, and Complete Profile, in FR and EN.",
  ...
  return (
    <main className="cv-page">
      ...
      <header className="cv-page-hero">
        ...
        <p data-anim="up">Agroeconomics, data engineering, development, or hybrid profile: choose the version that fits your needs, in French or English.</p>
      </header>
      <CvSection locale="en" />
