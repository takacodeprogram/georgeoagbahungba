...
export const projects = [
  ...
  { name: "Musimaps", url: "https://musimaps.app", image: "/media/project-musimaps.webp", category: "Cartographie & Culture", code: "MM", sector: "dev", description: "Application web et mobile pour explorer les artistes et les cultures musicales à travers une cartographie interactive.", tags: ["Web", "Mobile", "Géodata"] },
  { name: "Lokali", url: "https://lokali.bj", image: "/media/project-lokali.webp", category: "Plateforme locale", code: "LO", sector: "dev", description: "Plateforme béninoise de consultation des prix agricoles : données du marché, recherche et filtres pour suivre les produits au Bénin.", tags: ["Web", "Prix agricoles", "Bénin"] },
  ...
  { name: "Content Factory", url: "https://content-factory-rose.vercel.app/login", image: "/media/project-contentfactory.webp", category: "IA & Automatisation", code: "CF", sector: "dev", description: "Système intelligent pour générer, valider, planifier et diffuser du contenu sur plusieurs canaux.", tags: ["IA", "Automatisation", "Contenu"] },
  { name: "ANOPER — Cartes membres", url: "https://anoper.bj/card-create-system/", category: "Solution métier", code: "AN", sector: "dev", description: "Plateforme de gestion pour générer, administrer et exporter les cartes des membres de l’association.", tags: ["Association", "Gestion", "Digitalisation"] },
  { name: "Plateforme filière soja", url: "https://platformparcsojaidid-dqhk.vercel.app/", category: "Agritech", code: "SO", sector: "agri", description: "Ressources éducatives pour les acteurs de la filière soja et modernisation de la présence numérique d’IDID.", tags: ["Agritech", "Filière", "Digitalisation"] },
  { name: "Ire Ayodé", url: "https://ireayode.bj", category: "Data agricole", code: "IA", sector: "agri", description: "Visualisation des données KoboCollect des coopératives d’anacarde dans les Collines du Bénin.", tags: ["Coopératives", "Data", "Terrain"] },
  { name: "Lottery dApp", url: "https://lottery-nextjs-dapp-triplecrowndiamond.vercel.app/", category: "Web3", code: "W3", sector: "dev", description: "Loterie décentralisée pour explorer la blockchain et les contrats intelligents de bout en bout.", tags: ["Web3", "Blockchain", "Expérimentation"] },
...
export const skills = {
  dev: ["JavaScript", "TypeScript", "React", "Next.js", "Node.js", "PHP", "Laravel", "Flutter", "React Native", "Expo", "WordPress", "SQL", "Supabase", "Google Cloud", "AWS Cloud", "Git", "GitHub", "Docker", "APIs", "IA générative"],
  agro: ["Python", "SQL", "R", "Stata", "SPSS", "Excel", "KoboToolbox", "ODK", "Power BI", "QGIS", "Économétrie", "Statistiques", "Analyse de données", "Suivi-évaluation", "Évaluation d'impact"],
};
...
PARCOURS (timeline)
${journey.map((item) => `- ${item.period} : ${item.role} (${item.org}) — ${item.detail}`).join("\n")}
